...
export default function TaskItem() {
    ...
    return (
        <>
        <div className="h-auto border border-slate-400 rounded shadow-xl p-5">
            <div className="flex flex-row items-center justify-between">
                <div className="flex items-center">
                    <input id="checkbox" type="checkbox" class="h-5 w-5 cursor-pointer mr-2"/>

                    <label for="checkbox" className="text-lg font-medium">
                        <span className="text-red-600 text-xl font-bold mx-2">!</span>
                        Task 1
                    </label>
                ...
                <div className="flex items-center">
                    <button className="cursor-pointer hover:bg-slate-300 rounded p-2">
                        <FaEllipsisV />
                    </button>
                </div>
            </div>

            <div className="flex items-center text-slate-600 my-2">
                <FaCalendar className="h-4 mr-2"/>
                <span>26/05/2025</span>
            </div>

            <p className="truncate text-sm mt-5">
